...
sealed class Destinations(
    ...
    object AsistenciapaUI: Destinations("asistenciapaUI","Adm. Asistenciapas", Icons.Filled.DateRange)

    object AsistenciapaForm: Destinations("asistenciapaForm?asisId={asisId}", "Form Asistenciapa", Icons.Filled.Add){
        fun passId(asisId:String?):String{
            return "asistenciapaForm?asisId=$asisId"
        }
    }
