...
class DataSourceModule {
    ...
    @Singleton
    @Provides
    fun restAsistenciapa(retrofit: Retrofit):RestAsistenciapa{
        return retrofit.create(RestAsistenciapa::class.java)
    }
    ...
    @Singleton
    @Provides
    fun asistenciapaDao(db:DbDataSource):AsistenciapaDao{
        return db.asistenciapaDao()
    }
}