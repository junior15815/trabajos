...
import pe.edu.upeu.asistenciaupeujc.repository.AsistenciapaRepositoryImp
...
abstract class RepositoryModule {
    ...
    @Binds
    @Singleton
    abstract fun asistenciapaRepository(asisRepos: AsistenciapaRepositoryImp): AsistenciapaRepository
